...
const CloseIcon:React.FC<CloseIconProps> = ({onClick}) => {
    ...
    return (
        <svg onClick={onClick}  id="cierra-musica" width="40px" height="33px" viewBox="0 0 40 33" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        <g className={styles.CloseIcon} id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="Group">
